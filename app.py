...
def preparation():
    ...
    qa = [
        ...
        {"question":"Tell me about yourself",
         "answer":"Start with your background, current studies, and key skills."},

        {"question":"What are your strengths?",
         "answer":"Mention strengths with examples."},

        {"question":"What are your weaknesses?",
         "answer":"Mention weakness and improvement."},

        {"question":"Why should we hire you?",
         "answer":"Explain why you're suitable."},

        {"question":"Why do you want to work here?",
         "answer":"Align your goals with company."},

        {"question":"Describe a challenge you faced",
         "answer":"Use STAR method."},

        {"question":"Where do you see yourself in 5 years?",
         "answer":"Show growth and ambition."},

        {"question":"Tell me about teamwork experience",
         "answer":"Explain your role in team."},

        {"question":"How do you handle pressure?",
         "answer":"Give real example."},

        {"question":"What motivates you?",
         "answer":"Talk about growth and learning."}
